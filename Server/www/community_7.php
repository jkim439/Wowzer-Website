...
$board = mysql_real_escape_string("bbs_vip");
...
// 읽기 권한 확인
if($member[level]<3) {
	echo "<script>self.location.href='error_401.php?level=3';</script>"; exit;
}
		...
		<tr>
			...
			<td	id="layout_right">
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td	style="width:750px; height:37px; background-image:url('http://akeetes430.cdn2.cafe24.com/title_5_7.gif');"></td>
					</tr>
					<tr>
