...
class PMA_Config
{
    ...
    function checkFontsize()
    {
        ...
        if (preg_match('/^[0-9.]+(px|em|pt|\%)$/', $new_fontsize)) {
            ...
            // of 16, but use 78% to help read the monoface font
            $this->set('fontsize', '78%');
        }

        if (function_exists('PMA_setCookie')) {
            PMA_setCookie('pma_fontsize', $this->get('fontsize'), '78%');
        }
    }
     ...
     */
    static protected function _getFontsizeOptions($current_size = '78%')
    {
