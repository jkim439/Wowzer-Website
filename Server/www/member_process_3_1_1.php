...
<head>
	...
	<script	type="text/javascript">
		function submit_check() {
			...
			if(document.level.term_3.value=="0"){
				alert(" 조건 중 만족하지 못한 조건이 있습니다. ");
				return false;
			}
		}
				...
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<br><br><br>
							<form name="level" target="_self" method="post" action="member_process_3_1_2.php" onsubmit="return submit_check();" enctype="multipart/form-data">
							<p align="center">
				        				...
				        				<tr>
				        					<td style="width:400px;">
														<p style="margin-right:15pt; margin-left:15pt;"><font face="Gulim" color="white"><span style="font-size:9pt;">
															<strong>등업 신청</strong> (변경 요청-전문 기술 변경)
														</span></font></p>
													</td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><strong><?=$member[$character_name]?></strong> 캐릭터의 전문기술 2개를 선택해 주세요.<br><br>
				        		...
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										<td id="layout_mini_2_left">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="#311400"><span style="font-size:9pt;">
												<center><strong>조건</strong></center>
											</span></font></p>
										</td>
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><strong>아래 조건이 모두 만족해야 합니다.</strong><br><br>1. <strong>전문기술 2개</strong>를 배우셔야 합니다. (숙련도 상관없이 배우기만 하면 됩니다)<font id="term_3_1" color="blue" style="display:none;"><strong> [만족]</strong></font><font id="term_3_2" color="red"><strong> [불만족]</strong></font><br><br>
											</span></font></p>
										</td>
									</tr>
									<tr>
