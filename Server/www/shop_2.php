...
// 상점 아이템 로드
$item_db = mysql_query("SELECT COUNT(*) FROM item where kind=1",$dbconn);
...
// 상점 아이템 목록
if($type=="1") {
	$item_list = mysql_query("SELECT * FROM item WHERE kind=1 and ino>1 and ino<54", $dbconn);
} else {
	$item_list = mysql_query("SELECT * FROM item WHERE kind=1 and ino>53", $dbconn);
...
<body bgcolor="#00384a" onload="java_check_shop_iframe(); frame_check();" onpropertychange="defence_check();" oncontextmenu="return false;" style="cursor:default;">
	...
	<div id="layout_shop_iframe" style="display:none;">
		<p align="center"><font face="Gulim" color="white"><span style="font-size:9pt;">
			<img src="http://akeetes430.cdn2.cafe24.com/shop_title_2.gif" width="500" height="40" border="0">
		</span></font></p>
		<p style="margin-left:20pt; margin-right:10pt;"><font face="Gulim" color="white"><span style="font-size:9pt;">
			<br><br><br>일반적인 하급 캐릭터의 아바타입니다. (총 <strong><?=$i-1?></strong>개)
			<br><br><br>
			<?if($type=="1" || $type=="2"){?>
			...
			<?}else{?>
				<p align="center">
					<a href="shop_2.php?type=1" target="_self"><img src="http://akeetes430.cdn2.cafe24.com/shop_button_man_1.gif"	name="button_1" width="200" height="100" border="0"	OnMouseOut="button_1.src='http://akeetes430.cdn2.cafe24.com/shop_button_man_1.gif'"	OnMouseOver="button_1.src='http://akeetes430.cdn2.cafe24.com/shop_button_man_2.gif'" align="bottom" alt=""></a>&nbsp;&nbsp;&nbsp;<a href="shop_2.php?type=2" target="_self"><img src="http://akeetes430.cdn2.cafe24.com/shop_button_woman_1.gif"	name="button_2" width="200" height="100" border="0"	OnMouseOut="button_2.src='http://akeetes430.cdn2.cafe24.com/shop_button_woman_1.gif'"	OnMouseOver="button_2.src='http://akeetes430.cdn2.cafe24.com/shop_button_woman_2.gif'" align="bottom" alt=""></a>
				</p>
			<?}?>
		</span></font></p>
	</div>
