		...
		<tr>
			...
			<td	id="layout_right">
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td	style="width:750px; height:37px; background-image:url('http://akeetes430.cdn2.cafe24.com/title_7_1.gif');"></td>
					</tr>
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<br><br><br>
							<p align="center">
								<form name="find" target="_self" method="post" action="help_find_2_2.php">
					        			...
					        			<tr>
					        				...
					        				<td style="width:350px;">
														<p style="margin-right:15pt; margin-left:15pt;" align="right"><font face="Gulim" color="white"><span style="font-size:9pt;">
															<input type="button" value=" 취소 " style="width:60px; height:23px; font-family:'Gulim'; font-size:9pt;" onclick="self.location.href='help_1.php';">
														</span></font></p>
													</td>
												</tr>
											</table>
				        		...
				        		<td id="layout_mini_2_line" colspan="2"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" style="height:80px;">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												계정에 등록된 이메일을 입력하세요. 그 이메일 주소로 비밀번호를 보내드립니다.<br><br><input type="text" name="email" onblur="defence_on(); this.style.padding='2px'; this.style.border='1px solid #FF9900';" onfocus="defence_off(); this.style.padding='1px'; this.style.border='2px solid #FF9900';" style="width:400px; height:22px; padding:1px; ime-mode:disabled; font-family:Arial; font-weight:bold; font-size:10pt; color:rgb(91,43,0); border-width:1pt; border-color:rgb(255,153,0); border-style:solid;" maxlength="40">
											</span></font></p>
										</td>
									</tr>
									<tr>
