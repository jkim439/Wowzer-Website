		...
		<tr>
			...
			<td	id="layout_right">
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td	style="width:750px; height:37px; background-image:url('http://akeetes430.cdn2.cafe24.com/title_2_4.gif');"></td>
					</tr>
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<p style="margin-right:15pt; margin-left:15pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
								다른 길드에는 없는 저희 길드만의 포인트 제도에 대해 알려드립니다.<br><br>
								<img src="http://akeetes430.cdn2.cafe24.com/intro/intro_4.jpg" style="width:576px; height:783px;" border="0" align="bottom" alt="">
