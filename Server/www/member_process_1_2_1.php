...
<head>
	...
	<script	type="text/javascript">
		...
		function term_3_check() {
			if(document.level.achievement.value>799) {
		...
		function term_4_check() {
			if(document.level.skill_master.value!="0") {
				document.getElementById("term_4_1").style.display='';
				document.getElementById("term_4_2").style.display='none';
				document.level.term_4.value="1";
			} else {
				document.getElementById("term_4_1").style.display='none';
				document.getElementById("term_4_2").style.display='';
				document.level.term_4.value="0";
			}
		}
	</script>
				...
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<br><br><br>
							<form name="level" target="_self" method="post" action="member_process_1_2_2.php" onsubmit="return submit_check();" enctype="multipart/form-data">
							<p align="center">
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><?=$member[character_1_name]?> 캐릭터의 업적 점수를 입력하세요.<br><br><input type="text" name="achievement" onkeyup="term_3_check();" onKeyPress="return only_num(event, false);" onblur="defence_on(); this.style.padding='2px'; this.style.border='1px solid #FF9900';" onfocus="defence_off(); this.style.padding='1px'; this.style.border='2px solid #FF9900';" style="width:55px; height:25px; padding:1px; ime-mode:disabled; font-family:Arial; font-weight:bold; font-size:12pt; color:rgb(91,43,0); border-width:1pt; border-color:rgb(255,153,0); border-style:solid;" maxlength="4"><br><br>
											</span></font></p>
										</td>
									</tr>
									<tr>
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><?=$member[character_1_name]?> 캐릭터 마스터(숙련도 450)한 전문기술 중 1개를 선택하세요.<br><br>
												<select name="skill_master" size="1" onchange="term_4_check();" style="width:150px; height:25px; padding:1px; font-family:Gulim; font-size:9pt; color:rgb(0,0,0);">
				        		...
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><strong>Silver</strong> 등급의 등업 조건은 다음과 같습니다.<br><br>1. 포인트 상점에서 판매 중인 <font color="#0048ff"><strong>[은메달 아이템]</strong></font>을 보유하셔야 합니다.<?if($term_1_value>0){?><font color="blue"><strong> [만족]</strong></font><?}else{?><font color="red"><strong> [불만족]</strong></font><?}?><br><br>2. <strong>칭호</strong>가 있어야 합니다.<?if($term_2_value>0){?><font color="blue"><strong> [만족]</strong></font><?}else{?><font color="red"><strong> [불만족]</strong></font><?}?><br><br>3. 메인 캐릭터의 <strong>업적 점수가 800점 이상</strong>이어야 합니다.<font id="term_3_1" color="blue" style="display:none;"><strong> [만족]</strong></font><font id="term_3_2" color="red"><strong> [불만족]</strong></font><br><br>4. <strong>전문기술 2개 중 1개를 마스터</strong>해야 합니다. (숙련도 450 이상)<font id="term_4_1" color="blue" style="display:none;"><strong> [만족]</strong></font><font id="term_4_2" color="red"><strong> [불만족]</strong></font><br><br>
											</span></font></p>
										</td>
									</tr>
									<tr>
			        		...
			        		<td style="height:80px;" colspan="4">
			        			<center><input type="hidden" name="term_1" value="<?=$term_1_value?>"><input type="hidden" name="term_2" value="<?=$term_2_value?>"><input type="hidden" name="term_3" value="0"><?if($term_4_value>0){?><input type="hidden" name="term_4" value="1"><?}else{?><input type="hidden" name="term_4" value="0"><?}?><input type="submit" value=" 신청 " style="width:80px; height:23px; font-family:'Gulim'; font-size:9pt;">
			        		</td>
			    			</tr>
								</table>
							</form>
