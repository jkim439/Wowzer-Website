...
// 등업 조건 확인
if($member[level]<4 || $member[level_state]=="1") {
  echo "<script>self.location.href='$site_403';</script>"; exit;
}
...
<head>
	...
	<script	type="text/javascript">
		function submit_check() {
			if(document.level.term_2.value=="0" || document.level.term_3.value=="0"){
				...
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<br><br><br>
							<form name="level" target="_self" method="post" action="member_process_2_3_2.php" onsubmit="return submit_check();" enctype="multipart/form-data">
							<p align="center">
				        				...
				        				<tr>
				        					<td style="width:300px;">
														<p style="margin-right:15pt; margin-left:15pt;"><font face="Gulim" color="white"><span style="font-size:9pt;">
															<strong>등업 신청</strong> (서브 캐릭터-Gold로 등업)
														</span></font></p>
													</td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><?=$member[$character_name]?> 캐릭터의 업적 점수를 입력하세요.<br><br><input type="text" name="achievement" onkeyup="term_2_check();" onKeyPress="return only_num(event, false);" onblur="defence_on(); this.style.padding='2px'; this.style.border='1px solid #FF9900';" onfocus="defence_off(); this.style.padding='1px'; this.style.border='2px solid #FF9900';" style="width:55px; height:25px; padding:1px; ime-mode:disabled; font-family:Arial; font-weight:bold; font-size:12pt; color:rgb(91,43,0); border-width:1pt; border-color:rgb(255,153,0); border-style:solid;" maxlength="4"><br><br>
											</span></font></p>
										</td>
									</tr>
									<tr>
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><?=$member[$character_name]?> 캐릭터가 마지막으로 마스터(숙련도 450 이상)한 전문기술 1개를 선택하세요.<br><br>
				        		...
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br><strong>Gold</strong> 등급의 등업 조건은 다음과 같습니다.<br><br>1. 메인 캐릭터의 <strong>업적 점수가 1600점 이상</strong>이어야 합니다.<font id="term_2_1" color="blue" style="display:none;"><strong> [만족]</strong></font><font id="term_2_2" color="red"><strong> [불만족]</strong></font><br><br>2. <strong>전문기술 2개를 모두 마스터</strong>해야 합니다. (숙련도 450 이상)<font id="term_3_1" color="blue" style="display:none;"><strong> [만족]</strong></font><font id="term_3_2" color="red"><strong> [불만족]</strong></font><br><br>
											</span></font></p>
										</td>
									</tr>
									<tr>
			        		...
			        		<td style="height:80px;" colspan="4">
			        			<center><input type="hidden" name="character" value="<?=$character?>"><input type="hidden" name="term_2" value="0"><input type="hidden" name="term_3" value="0"><input type="submit" value=" 신청 " style="width:80px; height:23px; font-family:'Gulim'; font-size:9pt;">
			        		</td>
			    			</tr>
								</table>
							</form>
