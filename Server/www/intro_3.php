		...
		<tr>
			...
			<td	id="layout_right">
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td	style="width:750px; height:37px; background-image:url('http://akeetes430.cdn2.cafe24.com/title_2_3.gif');"></td>
					</tr>
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<p style="margin-right:15pt; margin-left:15pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
								길드 참여도와 게임 이용도, 그리고 홈피 참여도에 따라 정해지는 등급 제도에 대해 알려드립니다.<br><br>
								<img src="http://akeetes430.cdn2.cafe24.com/intro/intro_3.jpg" style="width:574px; height:915px;" border="0" align="bottom" alt="">
