...
if($character_num>9) {
	echo "<script>alert(' 캐릭터 등록은 최대 9개까지만 가능합니다. ');self.location.href='member_6.php';</script>"; exit;
}
?>
...
<head>
	...
	<script	type="text/javascript">
		function submit_check() {
			if(document.level.character_name.value.length==0) {
				alert(" 캐릭터 이름을 입력해 주세요. ");
				document.level.character_name.focus();
				return false;
			}
			if(document.level.character_level.value.length==0) {
				alert(" 캐릭터 레벨을 입력해 주세요. ");
				document.level.character_level.focus();
				return false;
			}
			if(document.level.character_job.value=="0"){
				alert(" 캐릭터 직업을 선택해 주세요. ");
				document.level.character_job.focus();
				return false;
			}
			if(document.level.character_skill_1.value=="0"){
				alert(" 첫번째로 배운 전문기술을 선택해 주세요. ");
				document.level.character_skill_1.focus();
				return false;
			}
			if(document.level.character_skill_2.value=="0"){
				alert(" 두번째로 배운 전문기술을 선택해 주세요. ");
				document.level.character_skill_2.focus();
				return false;
			}
			if(document.level.character_skill_1.value==document.level.character_skill_2.value){
				...
				document.level.character_skill_1[0].selected=true;
				document.level.character_skill_2[0].selected=true;
				document.level.character_skill_1.focus();
				return false;
			}
			if(document.level.character_level.value<1 || document.level.character_level.value>80) {
				...
				document.level.character_level.value="";
				document.level.character_level.focus();
				return false;
			}
		...
		function term_2_check() {
			if(document.level.character_level.value>19) {
		...
		function term_3_check() {
			if(document.level.character_skill_1.value!="0" && document.level.character_skill_2.value!="0") {
				...
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<br><br><br>
							<form name="level" target="_self" method="post" action="member_process_2_1_2.php" onsubmit="return submit_check();" enctype="multipart/form-data">
							<p align="center">
				        				...
				        				<tr>
				        					<td style="width:400px;">
														<p style="margin-right:15pt; margin-left:15pt;"><font face="Gulim" color="white"><span style="font-size:9pt;">
															<strong>등업 신청</strong> (서브 캐릭터-Bronze로 등업)
														</span></font></p>
													</td>
				        				<td style="width:250px;">
													<p style="margin-right:15pt; margin-left:15pt;" align="right"><font face="Gulim" color="white"><span style="font-size:9pt;">
														<input type="button" value=" 취소 " style="width:60px; height:23px; font-family:'Gulim'; font-size:9pt;" onclick="self.location.href='member_process_2_0.php';">
													</span></font></p>
												</td>
												</tr>
											</table>
				        		...
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br>등록할 캐릭터의 레벨을 입력해 주세요.<br><br><input type="text" name="character_level" onkeyup="term_2_check();" onKeyPress="return only_num(event, false);" onblur="defence_on(); this.style.padding='2px'; this.style.border='1px solid #FF9900';" onfocus="defence_off(); this.style.padding='1px'; this.style.border='2px solid #FF9900';" style="width:55px; height:25px; padding:1px; ime-mode:disabled; font-family:Arial; font-weight:bold; font-size:12pt; color:rgb(91,43,0); border-width:1pt; border-color:rgb(255,153,0); border-style:solid;" maxlength="2"><br><br>
											</span></font></p>
										</td>
									</tr>
									<tr>
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br>등록할 캐릭터의 직업을 선택해 주세요.<br><br>
												<select name="character_job" size="1" style="width:150px; height:25px; padding:1px; font-family:Gulim; font-size:9pt; color:rgb(0,0,0);">
				        		...
				        		<td id="layout_mini_2_line" colspan="4"></td>
									...
									<tr>
										...
										<td id="layout_mini_2_right" colspan="3">
											<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												<br>등록할 캐릭터가 배운 전문기술 2개를 선택해 주세요.<br><br>
												<select name="character_skill_1" size="1" onchange="term_3_check();" style="width:150px; height:25px; padding:1px; font-family:Gulim; font-size:9pt; color:rgb(0,0,0);">
												...
												<select name="character_skill_2" size="1" onchange="term_3_check();" style="width:150px; height:25px; padding:1px; font-family:Gulim; font-size:9pt; color:rgb(0,0,0);">
			        		...
			        		<td style="height:80px;" colspan="4">
			        			<center><input type="hidden" name="term_1" value="0"><input type="hidden" name="term_2" value="0"><input type="hidden" name="term_3" value="0"><input type="submit" value=" 신청 " style="width:80px; height:23px; font-family:'Gulim'; font-size:9pt;">
			        		</td>
			    			</tr>
								</table>
							</form>
