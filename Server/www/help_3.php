		...
		<tr>
			...
			<td	id="layout_right">
				<table id="layout_right_"	border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td	style="width:750px; height:37px; background-image:url('http://akeetes430.cdn2.cafe24.com/title_7_3.gif');"></td>
					</tr>
					<tr>
						<td	style="width:750px;"	bgcolor="white"	valign="top">
							...
							<br><br><br>
							<p align="center">
								<form name="find" target="_self" method="post" action="help_3_process.php">
									...
									<tr>
										...
										<td id="layout_mini_2_right" style="height:80px;">
											<br><p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="black"><span style="font-size:9pt;">
												...
												<input type="button" value=" 재시도 " onclick="if(confirm(' 입력한 내용이 모두 지워집니다. 계속하시겠습니까? ')){self.location.href='help_3.php';} else return false;" style="width:80px; height:23px; font-family:'Gulim'; font-size:9pt;">
											<br><br></span></font></p>
										</td>
									</tr>
									<tr>
