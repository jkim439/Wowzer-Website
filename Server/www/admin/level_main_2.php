...
// 무단 접속 확인
if($vmember[level_state]!="1" || $vmember[character_mode]!="1") {
...
$level = "Copper";
$level_up = "Bronze";
} elseif($vmember[level]=="2") {
$level = "Bronze";
$level_up = "Silver";
} elseif($vmember[level]=="3") {
$level = "Silver";
$level_up = "Gold";
} elseif($vmember[level]=="4") {
$level = "Gold";
$level_up = "Staff";
} else {
$level = "Master";
...
if($vmember[level]=="1"){
	...
	$character_name = $vmember[character_1_name];
											// 전문기술 명칭
											if($vmember[character_1_skill_1]=="1") $character_skill_1 = "Herballsm";
											if($vmember[character_1_skill_1]=="2") $character_skill_1 = "Mining";
											if($vmember[character_1_skill_1]=="3") $character_skill_1 = "Skinning";
											if($vmember[character_1_skill_1]=="4") $character_skill_1 = "Alchemy";
											if($vmember[character_1_skill_1]=="5") $character_skill_1 = "Blacksmithing";
											if($vmember[character_1_skill_1]=="6") $character_skill_1 = "Engineering";
											if($vmember[character_1_skill_1]=="7") $character_skill_1 = "Leatherworking";
											if($vmember[character_1_skill_1]=="8") $character_skill_1 = "Tailoring";
											if($vmember[character_1_skill_1]=="9") $character_skill_1 = "Enchanting";
											if($vmember[character_1_skill_1]=="10") $character_skill_1 = "Jewelcrafting";
											if($vmember[character_1_skill_1]=="11") $character_skill_1 = "Inscription";
											if($vmember[character_1_skill_2]=="1") $character_skill_2 = "Herballsm";
											if($vmember[character_1_skill_2]=="2") $character_skill_2 = "Mining";
											if($vmember[character_1_skill_2]=="3") $character_skill_2 = "Skinning";
											if($vmember[character_1_skill_2]=="4") $character_skill_2 = "Alchemy";
											if($vmember[character_1_skill_2]=="5") $character_skill_2 = "Blacksmithing";
											if($vmember[character_1_skill_2]=="6") $character_skill_2 = "Engineering";
											if($vmember[character_1_skill_2]=="7") $character_skill_2 = "Leatherworking";
											if($vmember[character_1_skill_2]=="8") $character_skill_2 = "Tailoring";
											if($vmember[character_1_skill_2]=="9") $character_skill_2 = "Enchanting";
											if($vmember[character_1_skill_2]=="10") $character_skill_2 = "Jewelcrafting";
											if($vmember[character_1_skill_2]=="11") $character_skill_2 = "Inscription";
											if($vmember[character_1_job]=="1") $character_job = "죽음의 기사";
											if($vmember[character_1_job]=="2") $character_job = "전사";
											if($vmember[character_1_job]=="3") $character_job = "도적";
											if($vmember[character_1_job]=="4") $character_job = "사냥꾼";
											if($vmember[character_1_job]=="5") $character_job = "마법사";
											if($vmember[character_1_job]=="6") $character_job = "흑마법사";
											if($vmember[character_1_job]=="7") $character_job = "사제";
											if($vmember[character_1_job]=="8") $character_job = "성기사";
											if($vmember[character_1_job]=="9") $character_job = "주술사";
											if($vmember[character_1_job]=="10") $character_job = "드루이드";
...
<body onload="screen();">
	<center>
	<form name="admin" target="_self" method="post" action="level_main_3.php">
	<table cellpadding="0" cellspacing="0" style="width:100%; height:100%;">
		<tr>
			...
			<td rowspan="13" style="height:100%;">
				<p align="left">
					<iframe src="http://armory.molten-wow.com/character-profile/<?=$character_name?>/Neltharion/" style="width:100%; height:100%;" vspace="0" hspace="0" marginwidth="0" marginheight="0" frameborder="0"></iframe>
				</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="width:300px; height:40px;">
				<p style="margin-right:10pt; margin-left:10pt; font-family:Arial;"><font face="Arial" color="black"><span style="font-size:12pt; font-family:Arial;">
					<?if($vmember[level]=="3"){?><img src="http://akeetes430.cdn2.cafe24.com/icon_gold.gif" align="absmiddle" style="width:20px; height:13px;"> Gold<?}elseif($vmember[level]=="2"){?><img src="http://akeetes430.cdn2.cafe24.com/icon_silver.gif" align="absmiddle" style="width:20px; height:13px;"> Silver<?}else{?>Bronze<?}?>
				</span></font></p>
			</td>
    </tr>
		<?if($vmember[level]=="1"){?><tr>
			...
			<td style="width:300px; height:70px;">
				<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="red"><span style="font-size:9pt;">
					...
					<input type="text" id="skill" value="<?=$character_skill_1?> / <?=$character_skill_2?>" readonly style="width:230px; height:23px font-size:10pt; font-family:Arial;"> <input type="button" value="복사" style="width:40px; height:23px; font-family:'Gulim'; font-weight:bold; font-size:9pt;" onclick="copy();">
				</span></font></p>
			</td>
    </tr><?}?>
		<tr>
		...
		<tr>
			...
			<td style="width:300px; height:40px;">
				<p style="margin-right:10pt; margin-left:10pt;"><font face="Gulim" color="#311400"><span style="font-size:9pt;">
					...
					<?if($vmember[level]=="1"){?><a href="javascript:alert(' Bronze 등업 조건 \n\n 1. 레벨 20 이상 \n 2. ES 길드 가입 \n 3. 전문 기술 2개 배웠는지 \n 4. 신청 정보와 실제 정보가 맞는지 \n\n 자세한 내용은 [도움] 버튼을 클릭하시기 바랍니다. ');">[승인 전 필독]</a></font><?}?>
					<?if($vmember[level]=="2"){?><a href="javascript:alert(' Silver 등업 조건 \n\n 1. 업적 점수 800점 이상 \n 2. 전문 기술 1개 만숙련(마스터) \n\n 자세한 내용은 [도움] 버튼을 클릭하시기 바랍니다. ');">[승인 전 필독]</a></font><?}?>
					<?if($vmember[level]=="3"){?><a href="javascript:alert(' Gold 등업 조건 \n\n 1. 업적 점수 1600점 이상 \n 2. 전문 기술 2개 만숙련(마스터) \n\n 자세한 내용은 [도움] 버튼을 클릭하시기 바랍니다. ');">[승인 전 필독]</a></font><?}?>
		...
		<tr>
			<td colspan="2" style="width:400px; height:35px;">
				<p align="center">
					<input type="hidden" name="sno" value="<?=$sno?>"><input type="hidden" name="url" value="<?=$url?>"><input type="hidden" name="no" value="<?=$vmember[no]?>"><input type="submit" name="submit" value=" 확인 " disabled style="width:80px; height:23px; font-family:'Gulim'; font-size:9pt;"> <input type="button" value=" 취소 " style="width:80px; height:23px; font-family:'Gulim'; font-size:9pt;" onclick="location.href='level_main_1.php';"> <input type="button" value=" 도움 " style="width:80px; height:23px; font-family:'Gulim'; font-size:9pt;" onclick="helper('main_<?=$vmember[level]?>.jpg');">
				</p>
			</td>
    </tr>
    <tr>
