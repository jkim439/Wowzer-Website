...
// 등업 신청자 리스트
$time=time();
$result = mysql_query("SELECT * FROM member WHERE level_state='1' and character_mode='1' and level_time<=$time-172800 ORDER BY level_time", $dbconn);
?>
<center>메인 캐릭터
...
?>
                    ...
                    <tr <?=$bgs?>>
                        ...
                        <td width='50' height='35'>
                            <p align='center'><b><font face='굴림' color='black'><span style='font-size:9pt;'><?=$vmember[level]?> → <?=$vmember[level]+1?></span></font></b></p>
                        </td>
                        <td width='50' height='35'>
                            <p align='center'><b><font face='굴림' color='black'><span style='font-size:9pt;'><?=$time?></span></font></b></p>
                        </td>
                        <td width='35' height='35'>
                            <p align='center'><b><font face='굴림' color='black'><span style='font-size:9pt;'><input type='button' name='ok' value="처리" style="font-family:'굴림'; font-size:'9pt';" onclick="location.href='level_main_2.php?no=<?=$vmember[no]?>'"></span></font></b></p>
                        </td>
                    </tr><tr>
